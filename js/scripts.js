...
$(function() {
	...
	$('.project-submit').submit(function(e) {
		...
		$(this).closest('.intro__wrap').addClass('black');
		$(this).find('.project-submit__input').prop("readonly", true);
		e.preventDefault();
	});
	...
	$('.project-submit__reset').click(function(){
		...
		$(this).closest('.project-submit').find('.project-submit__submit').prop("disabled", true);;
	});
	...
	$('.project-submit__input').keyup(function(){
		...
		if (value.indexOf('https://github.com/') == 0) {
			...
			form.removeClass('correct').addClass('incorrect');
			submit.prop("disabled", true);
		} else {
			form.removeClass('correct').removeClass('incorrect');
			submit.prop("disabled", true);
		}
	})
	...
	$('.breakthrough-slider').slick({
		...
		arrows: true,
		lazyLoad: 'ondemand',
		appendArrows: '#breakthrough-slider-nav',
	...
	$('.impactful-contributor-slider').slick({
		dots: false,
		infinite: false,
		speed: 500,
		slidesToShow: 4,
	...
	$('.participants-slider').slick({
		...
		lazyLoad: 'ondemand',
		infinite: false,
		asNavFor: '.participants-heads',
		appendArrows: '#participants-slider-nav',
		prevArrow: '<div class="slick-prev"><svg class="arrow-r" role="img" aria-hidden="true"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="img/sprite-inline.svg#arrow-r"></use></svg></div>',
		nextArrow: '<div class="slick-next"><svg class="arrow-r" role="img" aria-hidden="true"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="img/sprite-inline.svg#arrow-r"></use></svg></div>',
		responsive: [
			{
